...
const Hero = () => {
   return (
       <div className="grid grid-cols-12 gap-2">
          <div className="w-auto col-span-12 md:col-span-6 z-30 pl-[115px] max-md:pl-4 ">
             <div className=" h-[160px] max-sm:mb-10 ">
             ...
             <div className="flex flex-row pt-10 max-sm:flex-col ">
          ...
          <div className=" flex justify-end col-span-12  md:col-span-6 mt-10 max-sm:justify-center">
             ...
             <Image width={680} height={640} className=" w-5/6 z-10 max-md:hidden max-lg:hidden max-xl:hidden max-sm:flex" src="/assets/smallComputer.png" alt=""/>
